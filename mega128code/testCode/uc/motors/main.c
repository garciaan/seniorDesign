...
#define MAX_SPEED   3600  //in timer steps -- 1900usec @ 30.517578Hz
#define MIN_SPEED   2400  //in timer steps -- 1100usec @ 30.517578Hz
...
#define MOTOR_MAX 33000
#define BATTERY_VOLTAGE 16.1
